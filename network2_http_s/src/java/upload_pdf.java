...
public class upload_pdf extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String header = request.getHeader("uploaded_pdf");
            File srcfile = new File(header);
            String name = srcfile.getName();

            File destFile = new File("C:/Users/HP/pdf/" + name);
            String destpath = destFile.getAbsolutePath();
            Files.copy(srcfile.toPath(), destFile.toPath());
            Class.forName("com.mysql.jdbc.Driver");
            Connection c = DriverManager.getConnection("jdbc:mysql://localhost/http_project", "root", "");
            Statement s = c.createStatement();
            String q = "INSERT INTO `pdf` (`name`, `url`) VALUES ('" + name + "','" + destpath + "')";
            int result = 0;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(upload_pdf.class.getName()).log(Level.SEVERE, null, ex);
